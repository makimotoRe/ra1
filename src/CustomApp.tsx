...
import { authProvider as keycloakAuthProvider } from "./auth/keycloakAuthProvider";
import { initKeycloak, keycloak, setupTokenRefresh } from "./auth/keycloak";
import LoadingPage from './LoadingPage';
import { createTheme, ThemeProvider } from '@mui/material/styles';
import { CircularProgress, Button, Grid } from '@mui/material';
import SaveIcon from '@mui/icons-material/Save';
import DefaultLayout from "./layout/DefaultLayout";
import { i18nProvider } from "./messages/errorMessages";
import { BaseSnackbar } from "./shared/components/Snackbar/BaseSnackbar";
import AdminLoginPage from "./features/login/pages/AdminLoginPage";
import { DefaultDashboard } from "./features/dashboard/pages/DefaultDashboard";
