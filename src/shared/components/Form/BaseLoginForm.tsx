...
export const BaseLoginForm = (props: LoginFormProps) => {
  const {
    redirectTo,
    className,
    forgotPassword,
  ...
  return (
    ...
    >
      <CardContent className={LoginFormClasses.content}>
        ...
        {forgotPassword ? (
            <>
           {/* <StyledLink to={path}>Forgot Password?</StyledLink> */}
          <StyledButton variant="text" onClick={handleClick}>Forgot Password?</StyledButton>
            </>
        ) : null}
      </CardContent>
    </StyledForm>
